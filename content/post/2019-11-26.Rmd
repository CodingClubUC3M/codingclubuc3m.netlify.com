...
Both functions, `test_file()` and `test_dir()`, accept a parameter `reporter` with tree options:
...
Should we mock **all** of the dependencies?  Let's look into this a little bit.
...
This form of testing comprises tests that, er, test more than one unit (read: function) at a time.
